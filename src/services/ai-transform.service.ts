...
- 4~6문장 분량으로 충분히 설명하세요
- 첫 1~2문장: 무엇이 변경/개선되었는지 명확히 설명
- 중간 2~3문장: 이 변경이 실무자에게 어떤 도움이 되는지 구체적으로 설명 (예: "기존에는 ~해야 했지만, 이제는 ~할 수 있습니다", "~작업 시간이 줄어듭니다", "~오류가 방지됩니다")
- 마지막 1문장: 적용 범위나 유의사항이 있다면 안내
